...
# First, split balanced_indices into training and temp (validation + test)
...
# Updated Model Definition Using ResNet
...
# Updated train_model function with time recording and model saving
...
# To load and test the best saved weights
